...
class MyPaletteGeneratorController extends GetxController{
   ...
   getChip(int index,dynamic paletteGeneratorController){
     return ActionChip(
       label: Text("#color_"+(index+1).toString(),style: GoogleFonts.cairo(color: Uicolor.whiteColor,)),
       backgroundColor: paletteGeneratorController.color[index],
       onPressed: (){
         Clipboard.setData(ClipboardData(text: paletteGeneratorController.color[index].toString()));
