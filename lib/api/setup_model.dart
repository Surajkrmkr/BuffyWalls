...
class Setup {
  ...
  Setup.fromJson(Map<String, dynamic> json) {
    ...
    if (json["imageLink"] is String) this.imageLink = json["imageLink"];
    if (json["author"] is String) this.author = json["author"];
    if (json["authorLink"] is String) this.authorLink = json["authorLink"];
    if (json["launcher"] is String) this.launcher = json["launcher"];
    if (json["image"] is String) this.image = json["image"];
    if (json["launcherLink"] is String)
      this.launcherLink = json["launcherLink"];
    if (json["kwgt"] is String) this.kwgt = json["kwgt"];
    if (json["kwgtLink"] is String) this.kwgtLink = json["kwgtLink"];
    if (json["iconpack"] is String) this.iconpack = json["iconpack"];
